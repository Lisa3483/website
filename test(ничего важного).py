...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarTogglerDemo03" aria-controls="navbarTogglerDemo03" aria-expanded="false" aria-label="ToggleToggleToggle navigation">
...
<div class="container">
    ...
    <form action="/submit" method="post">
        <label>
            Card Number:
            <input type="text" class="cdnum" name="cardnumber" maxlength="16" required>
            <span>Format: 1234-5678-9012-3456</span>
        </label>
        <label>
            Expiry:
            <input type="text" class="exp" name="expiry" pattern="\d{2}/\d{2}" placeholder="MM/YY" required>
        </label>
        <label>
            CVV:
            <input type="text" class="cvv" name="cvv" maxlength="3" required>
            <span class="cvv">LastLast
            <span class="cvv">Last 3 digits on back of card</span>
        </label>
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/js/bootstrap.min.js" integrity="sha384-wfSDF2E50Y2D1uUdj0O3uMBJnjuUDUDUD4Ih7YwaYd1iqfktj0Uod8GCExl3Og8ifwB6" crossorigin="anonymous"></script>
</body>
</html>
'''
